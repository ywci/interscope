# src/isir/parser/ast.py
#
# Abstract Syntax Tree (AST) dataclasses for ISIR.
# These classes represent the parsed structure of a .isir file.
...
@dataclass
class Evidence:
    """Evidence attached to a ISIR element (full object with engine, status)."""
