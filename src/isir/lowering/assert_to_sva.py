# src/isir/lowering/assert_to_sva.py
#
...
def _collect_signals_robust(assert_module: asserts.AssertModule) -> Set[str]:
    signals: Set[str] = set()
    ops = (
...
def convert(assert_module: asserts.AssertModule,
