# src/isir/lowering/assert_to_vhdl.py
#
...
def _psl_default_clock(clock_op: Optional[asserts.AssertClockOp]) -> str:
...
def _assume_to_vhdl(assume: asserts.AssertAssumeOp,
                    mod_clock: Optional[asserts.AssertClockOp],
                    mod_reset: Optional[asserts.AssertResetOp]) -> str:
...
def _always_to_vhdl(always: asserts.AssertAlwaysOp,
                    mod_clock: Optional[asserts.AssertClockOp],
                    mod_reset: Optional[asserts.AssertResetOp]) -> str:
...
def _property_to_vhdl(prop: asserts.AssertPropertyOp,
                      mod_clock: Optional[asserts.AssertClockOp],
                      mod_reset: Optional[asserts.AssertResetOp]) -> str:
...
def _cover_to_vhdl(cover: asserts.AssertCoverOp,
                   mod_clock: Optional[asserts.AssertClockOp],
                   mod_reset: Optional[asserts.AssertResetOp]) -> str:
...
def convert(assert_module: asserts.AssertModule) -> str:
    """
    ...
    lines = []
    lines.append("-- Generated by InterScope from ISIR assertion dialect")
