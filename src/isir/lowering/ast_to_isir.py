# src/isir/lowering/ast_to_isir.py
#
# Canonical conversion from a parsed ISIR AST (parser.ast.Module)
# into the spec dialect (isir.SpecModule).
...
def convert_ast_to_isir_module(ast_module) -> SpecModule:
    """
