# src/isir/cli/sim.py
#
# CLI subcommand `sim` – parses a .isir file, compiles it to RTL
# (via Kōika), builds a Verilator simulation, runs it, and produces
# a VCD trace. Uses the canonical AST-to-ISIR converter.
...
def _setup_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="isir sim",
        description="Compile a ISIR design to RTL and run Verilator simulation."
    )
