# src/isir/verification/property_checker.py
#
# Evaluates ISIR properties (temporal properties, safety, liveness)
...
from isir.utils.expr import eval_expr, ExprError
...
def check_properties_from_spec(
    ...
    Args:
        spec_module: The parsed ISIR module (ast.Module).
        trace: Abstract trace list.
...
def check_properties_from_spec_dialect(
    ...
    """
    Check properties stored in a ISIR dialect SpecModule (isir.SpecModule).
