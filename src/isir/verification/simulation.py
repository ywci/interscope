# src/isir/verification/simulation.py
#
...
from isir.utils.config_loader import get_config, get_project_root
...
def _generate_input_testbench(
    ...
    tb_content = f"""// Auto-generated ISIR testbench for {design_name} with input driving
...
def simulate_design(
    ...
    Args:
        spec_module: The ISIR spec dialect module.
    ...
    logger.info("Lowering ISIR → RTL (Kōika Coq DSL) ...")
    try:
