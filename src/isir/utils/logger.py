...
# Log file is written to build/logs/isir.log (rotates at 10MB, keeps 5 backups).
...
def setup_logging(
    ...
    Args:
        ...
        log_file: Path to the log file. If None, uses 'build/logs/isir.log'.
    ...
    if file_enabled:
        if log_file is None:
            ...
            log_file = Path(log_dir) / "isir.log"
