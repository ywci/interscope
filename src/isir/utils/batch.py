# src/isir/utils/batch.py
#
# Batch processing utilities for InterScope.
# Provides functions to locate .isir files and execute a
...
def find_isir_files(
    ...
    """
    Recursively locate all .isir files under *directory*.

    Args:
        directory: Root directory to scan.
        pattern: Glob pattern (default ``*.isir``).
