# src/isir/utils/expr.py
#
# S-expression parser, evaluator, and type checker for ISIR expressions.
...
def eval_expr(expr: Union[str, List],
    ...
    """
    Evaluate a ISIR expression in the context of current state, inputs, and memories.
