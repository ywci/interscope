# src/isir/backends/verilator_sim.py
#
...
// Auto-generated ISIR testbench for {top_module}
...
def simulate(
    ...
    This is the primary entry point called by the ISIR CLI and
    integration tests.
    ...
    if output_dir is None:
        output_dir = Path(tempfile.mkdtemp(prefix="isir_sim_"))
    output_dir = Path(output_dir).resolve()
    output_dir.mkdir(parents=True, exist_ok=True)
